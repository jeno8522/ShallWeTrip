...
public class HotPlacePageBean implements Serializable{
    /**검색 조건*/
    ...
    /**페이지 시작 번호*/
    private int start=0;
    public HotPlacePageBean() {    }
    public HotPlacePageBean(String key, String word, int pageNo, String order) {
        setKey(key);
        setWord(word);
        setPageNo(pageNo);
        setOrder(order);
    }
    public HotPlacePageBean(String key, String word, String pageNo, String order) {
        setKey(key);
        setWord(word);
        setPageNo(pageNo);
        setOrder(order);
