    ...
    <div class="plan-section" id="body-content">
      <div class="row justify-content-center">
        ...
        <div class="article-section col-lg-8 col-md-10 col-sm-12">
          <form id="form-modify" method="post" action="${root}/hotPlace/modify">
<%--           	<input type='hidden'	name='pageNo'	value='${bean.pageNo}'/>
			...
			<input type='hidden'	name='word'		value='${bean.word}'/> --%>
          	...
          	<input type="hidden" name="hotId" value="${hotPlace.hotId}">
            <div class="mb-3">
              <label for="title" class="form-label">제목 : </label>
              <input type="text" class="form-control" id="title" name="title" value="${hotPlace.title}" />
            </div>
            <div class="mb-3">
              <label for="content" class="form-label">내용 : </label>
              <textarea class="form-control" id="content" name="content" rows="7">${hotPlace.content}</textarea>
            </div>
