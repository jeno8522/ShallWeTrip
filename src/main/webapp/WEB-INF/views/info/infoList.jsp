            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                ...
                <div class="col-md-7 offset-2">
                  <form class="d-flex" id="form-search" action="">
                    ...
                    >
                      ...
                      <option value="recommanded">추천순</option>
                    </select>
                    ...
                    >
                      ...
                      <option value="info_id">글번호</option>
              ...
              <table class="table table-hover">
                ...
                <c:forEach var="infoBoard" items="${infoBoards}"> 
                  <tr class="text-center article-row" data-no="${infoBoard.infoId}">
                    <th scope="row">${infoBoard.infoId}</th>
                    <td>${infoBoard.title}</td>
                    <td>${infoBoard.userId}</td>
                    <td>${infoBoard.hit}</td>
                    <td>${infoBoard.createDate}</td>
                  </tr>  
                </c:forEach>   
                </tbody>
              </table>
    ...
    <script>
      ...
      titles.forEach(function (title) {
        title.addEventListener("click", function () {
          ...
          location.href = "${root}/info/view?infoId=" + this.getAttribute("data-no");
        });
      });

      document.querySelector("#btn-mv-register").addEventListener("click", function () {
		<c:if test='${!empty userInfo}'>
			location.href = "${root}/info/write";
		</c:if>
		<c:if test='${empty userInfo}'>
      ...
      document.querySelector("#btn-search").addEventListener("click", function () {
          ...
          form.setAttribute("action", "${root}/info/infoList");
          form.submit();
      });
